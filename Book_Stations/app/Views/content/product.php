...
<div class="my-20 m-10">
    <div class="flex flex-row justify-between mb-4">
        <h2 class="text-3xl text-gray-400">Novels</h2>
        <!-- <a href="#" class="text-xl flex flex-row text-gray-400">View All
            <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 ml-1" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="256" height="256" viewBox="0 0 256 256" xml:space="preserve">
    ...
    <div class="grid grid-flow-row md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
        ...
        <?php if (count($list) > 0) { ?>
            ...
            <?php foreach ($list as $row) : ?>
                <div class="shadow-lg rounded-lg">
                    ...
                    <div class="p-5">
                        <h3 class="text-white italic text-2xl"><a href="#"><?= $row->name ?></a></h3>
